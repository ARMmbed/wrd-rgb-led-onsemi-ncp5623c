...
public:
    ...
    RGBLEDImplementation()
        :   led(YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_RGB_LED_I2C_SDA,
                YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_RGB_LED_I2C_SCL),
            ioexpander(YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_EXTERNAL_GPIO_I2C_SDA,
